const translations = {
    en: {
        ...
        nav_blog: "Blog",
        blog_subtitle: "Articles and thoughts",
        back_home: "Back to Portfolio",
        blog_coming_soon: "The blog is currently under construction...",
        ...
        video_credit: "Cinematic footage by <a href='https://instagram.com/tprk.mp4' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Toprak YAPICI</a>",
        stack_python: "Python",
        stack_c: "C",
        stack_cpp: "C++",
        stack_js: "JavaScript",
        ...
        blog_preview_desc: "Discover my latest articles, tutorials, and thoughts.",
        blog_preview_btn: "Read the Blog",
        read_articles: "Read Articles",
        blog_1_title: "Anatomy of a Web Request",
        blog_1_desc: "Ever wondered what happens when you type a URL into your browser?",
        blog_2_title: "The DNS System",
        blog_2_desc: "Discover how the DNS resolution process and records make the Internet work.",
        blog_3_title: "Emails: The SMTP Protocol",
        blog_3_desc: "Discover how your messages travel across the Internet and why they sometimes end up in spam.",
    ...
    fr: {
        ...
        nav_blog: "Blog",
        blog_subtitle: "Articles et réflexions",
        back_home: "Retour au portfolio",
        blog_coming_soon: "Le blog est en cours de construction...",
        hero_title: "Toine GUMUS",
        ...
        footer_text: "Portfolio - Toine GUMUS",
        video_credit: "Images cinématiques par <a href='https://instagram.com/tprk.mp4' target='_blank' rel='noopener noreferrer' style='color: inherit; text-decoration: underline;'>Toprak YAPICI</a>",
        stack_python: "Python",
        stack_c: "C",
        stack_cpp: "C++",
        stack_js: "JavaScript",
        ...
        blog_preview_title: "Derniers articles",
        blog_preview_desc: "Découvrez mes derniers articles, tutoriels et réflexions.",
        blog_preview_btn: "Lire le Blog",
        read_articles: "Lire les articles",
        blog_1_title: "Anatomie complète d'une requête web",
        blog_1_desc: "Avez-vous déjà réfléchi à ce qui se passe lorsque vous tapez une URL dans votre navigateur ?",
        blog_2_title: "Le système DNS",
        blog_2_desc: "Découvrez comment le processus de résolution DNS et ses enregistrements font fonctionner l'Internet.",
        blog_3_title: "Emails : Le protocole SMTP",
        blog_3_desc: "Découvrez comment vos messages traversent l'Internet et pourquoi ils finissent parfois en spam.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setLanguage(lang) {
        ...
        document.querySelectorAll('.blog-link').forEach(link => {
            ...
            if (currentHref) {
                if (currentHref.includes('/fr/') && lang === 'en') {
                    link.setAttribute('href', currentHref.replace('/fr/', '/en/'));
                } else if (currentHref.includes('/en/') && lang === 'fr') {
                    link.setAttribute('href', currentHref.replace('/en/', '/fr/'));
                }
            }
        });
    ...
    if (langBtn) {
        langBtn.addEventListener('click', () => {
            if (langBtn.classList.contains('blog-lang-redirect')) {
                const redirectUrl = langBtn.getAttribute('data-redirect');
                if (redirectUrl) {
